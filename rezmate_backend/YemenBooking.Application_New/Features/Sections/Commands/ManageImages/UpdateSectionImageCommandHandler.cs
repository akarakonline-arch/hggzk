...
{
    public class UpdateSectionImageCommandHandler : IRequestHandler<UpdateSectionImageCommand, ResultDto<ImageDto>>
    {
        private readonly ISectionImageRepository _repo;
        private readonly ICurrentUserService _currentUserService;
        public UpdateSectionImageCommandHandler(ISectionImageRepository repo, ICurrentUserService currentUserService)
        {
            _repo = repo;
            _currentUserService = currentUserService;
        }

        public async Task<ResultDto<ImageDto>> Handle(UpdateSectionImageCommand request, CancellationToken cancellationToken)
        {
