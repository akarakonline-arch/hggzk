...
import 'package:rezmate/core/enums/search_relaxation_level.dart';
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildLocationRow(),
                        if (widget.result.hasMismatches) ...[
                          const SizedBox(height: 4),
                          GestureDetector(
                            onTap: () => _showMismatchesBottomSheet(context),
                            child: PropertyMismatchBadgeWidget(
                              mismatches: widget.result.filterMismatches,
                              compact: true,
                            ),
                          ),
                        ],
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (widget.result.hasMismatches)
                              GestureDetector(
                                onTap: () =>
                                    _showMismatchesBottomSheet(context),
                                child: Padding(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // قائمة الفروقات المفصلة
                    PropertyMismatchBadgeWidget(
                      mismatches: widget.result.filterMismatches,
                      compact: false,
                    ),
                    const SizedBox(height: 16),
