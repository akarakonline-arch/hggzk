...
class _AnimatedAuthButtonState extends State<AnimatedAuthButton>
  ...
  Widget build(BuildContext context) {
    final customGradient = widget.gradient;
    final baseColor = AppTheme.primaryBlue;
    final gradientShadowColor =
        _gradientFirstColor(customGradient) ?? baseColor;
    final useSolidColor = !widget.isLoading && customGradient == null;
    final backgroundGradient = widget.isLoading
        ? LinearGradient(
            colors: [
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: [
                            ...
                            child: Opacity(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color:
                                      customGradient == null ? baseColor : null,
                  ...
                  Container(
                    decoration: BoxDecoration(
                      color: useSolidColor ? baseColor : null,
