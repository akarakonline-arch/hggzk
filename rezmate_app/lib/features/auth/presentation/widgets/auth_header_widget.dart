...
class _AuthHeaderWidgetState extends State<AuthHeaderWidget>
  ...
  Widget build(BuildContext context) {
    final Gradient effectiveGradient =
        widget.iconGradient ?? _buildDefaultGradient();
    final List<Color> gradientColors =
        _extractGradientColors(effectiveGradient);
    final Color primaryColor = widget.iconColor ?? gradientColors.first;
    final Color secondaryColor =
        gradientColors.length > 1 ? gradientColors[1] : gradientColors.first;
    final Gradient sweepGradient = SweepGradient(
      colors: [
        Colors.transparent,
    ...
    final Color shadowColor = primaryColor.withOpacity(0.4);
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color:
                            widget.iconGradient == null ? primaryColor : null,
...
List<Color> _extractGradientColors(Gradient gradient) {
