...
import 'package:rezmate/core/localization/app_localizations.dart';
import 'package:rezmate/features/support/presentation/cubit/support_cubit.dart';
import 'package:rezmate/features/support/presentation/cubit/support_state.dart';
...
class _SupportPageState extends State<SupportPage>
                  ...
                  slivers: [
                    SliverAppBar(
                      ...
                      flexibleSpace: FlexibleSpaceBar(
                        centerTitle: true,
                        title: Text(
                          localizations?.get('help_support') ?? 'Help & Support',
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    _buildContactFormCard(context, state, localizations),
                                    const SizedBox(height: 24),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      localizations?.get('support_description') ?? 'We are here to help you 24/7.',
                      style: TextStyle(
  ...
  Widget _buildContactFormCard(
      BuildContext context, SupportState state, AppLocalizations? localizations) {
    return ClipRRect(
      borderRadius: BorderRadius.circular(20),
      child: BackdropFilter(
        filter: ImageFilter.blur(sigmaX: 10, sigmaY: 10),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: state is SupportLoading ? null : () => _submitForm(context),
  ...
  void _showSuccessDialog(BuildContext context, AppLocalizations? localizations, String referenceNumber) {
    showDialog(
      context: context,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text(
                    localizations?.get('support_success_message') ?? 'Thank you for contacting us.',
