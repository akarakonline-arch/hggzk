...
// Removed SplashBloc imports as the splash now mirrors control_panel_app without external progress state
...
// Booking Icon Painter - identical visual to control_panel_app
    ...
    for (int i = 0; i < cardCount; i++) {
      ...
      final cardPaint = Paint()
        ...
        ..shader = LinearGradient(
          ...
          colors: [
            AppTheme.primaryBlue.withOpacity(0.3 + localAnimation * 0.3),
            AppTheme.primaryPurple.withOpacity(0.2 + localAnimation * 0.2),
          ],
...
class _SplashScreenState extends State<SplashScreen>
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          // Inner Circle with Glass Effect and Booking Icon
          Container(
            width: 120,
            height: 120,
            decoration: BoxDecoration(
  ...
  void _initializeAnimations() {
    ...
    // Calendar animation (for booking icon painter)
  ...
  void _checkAuthAndNavigate() {
    ...
    if (authState is AuthAuthenticated) {
      ...
      if (user.isEmailVerified) {
        ...
        // مستخدم غير مفعّل البريد، أرسله مباشرة لصفحة التحقق
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                // Loading Indicator with shimmer progress
                Column(
                  children: [
                    AnimatedBuilder(
                      animation: _textFade,
