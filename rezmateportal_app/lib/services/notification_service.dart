import 'dart:convert';
import 'dart:io';
import 'package:rezmateportal/features/chat/domain/entities/message.dart';
...
import 'package:rezmateportal/features/chat/presentation/bloc/chat_bloc.dart';
import 'package:rezmateportal/services/in_app_notification_service.dart';
...
class NotificationService {
  ...
  Future<void> _initializeLocalNotifications() async {
    ...
    const androidChannel = AndroidNotificationChannel(
      'rezmate_portal_channel',
      'rezmate Portal Notifications',
      description: 'إشعارات تطبيق حجزك بورتال',
      importance: Importance.high,
    );
    const androidScheduledChannel = AndroidNotificationChannel(
      'rezmate_portal_scheduled',
      'rezmate Portal Scheduled',
