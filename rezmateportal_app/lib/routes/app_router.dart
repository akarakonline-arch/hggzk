import 'dart:async';
import 'package:rezmateportal/features/admin_cities/domain/entities/city.dart';
import 'package:rezmateportal/features/admin_cities/presentation/pages/city_form_page.dart';
import 'package:rezmateportal/features/admin_units/domain/entities/unit.dart';
...
import 'package:rezmateportal/features/auth/presentation/bloc/auth_event.dart';
...
import 'package:rezmateportal/features/auth/presentation/pages/login_page.dart';
import 'package:rezmateportal/features/chat/presentation/widgets/conversation_loader.dart';
import 'package:rezmateportal/presentation/screens/futuristic_main_screen.dart';
import 'package:rezmateportal/presentation/screens/splash_screen.dart';
// Removed imports for deleted features
// Removed unused imports
import 'package:rezmateportal/features/auth/presentation/pages/register_page.dart';
import 'package:rezmateportal/features/auth/presentation/pages/forgot_password_page.dart';
import 'package:rezmateportal/features/auth/presentation/pages/verify_email_page.dart';
// Removed imports for deleted features
import 'package:rezmateportal/features/chat/presentation/pages/chat_page.dart';
import 'package:rezmateportal/features/chat/presentation/pages/new_conversation_page.dart';
import 'package:rezmateportal/features/chat/presentation/pages/conversations_page.dart';
import 'package:rezmateportal/features/chat/domain/entities/conversation.dart';
import 'package:rezmateportal/features/auth/presentation/pages/change_password_page.dart';
import 'package:rezmateportal/features/auth/presentation/pages/edit_profile_page.dart';
import 'package:rezmateportal/features/auth/presentation/pages/profile_page.dart';
// Removed settings pages imports
// Admin Units pages
import 'package:rezmateportal/features/admin_units/presentation/pages/units_list_page.dart';
import 'package:rezmateportal/features/admin_units/presentation/pages/create_unit_page.dart';
import 'package:rezmateportal/features/admin_units/presentation/pages/edit_unit_page.dart';
import 'package:rezmateportal/features/admin_units/presentation/pages/unit_details_page.dart';
import 'package:rezmateportal/features/admin_units/presentation/bloc/units_list/units_list_bloc.dart';
import 'package:rezmateportal/features/admin_units/presentation/bloc/unit_form/unit_form_bloc.dart';
import 'package:rezmateportal/features/admin_units/presentation/bloc/unit_details/unit_details_bloc.dart';
import 'package:rezmateportal/injection_container.dart' as di;
// Property Types page and blocs
import 'package:rezmateportal/features/property_types/presentation/pages/property_types_page.dart';
import 'package:rezmateportal/features/property_types/presentation/bloc/property_types/property_types_bloc.dart';
import 'package:rezmateportal/features/property_types/presentation/bloc/property_types/property_types_event.dart';
import 'package:rezmateportal/features/property_types/presentation/bloc/unit_types/unit_types_bloc.dart';
import 'package:rezmateportal/features/property_types/presentation/bloc/unit_type_fields/unit_type_fields_bloc.dart';
// removed wrong properties pages imports (files do not exist)
import 'package:rezmateportal/features/admin_services/presentation/pages/admin_services_page.dart';
import 'package:rezmateportal/features/admin_services/presentation/pages/create_service_page.dart';
import 'package:rezmateportal/features/admin_services/presentation/pages/edit_service_page.dart';
import 'package:rezmateportal/features/admin_amenities/presentation/pages/amenities_management_page.dart';
import 'package:rezmateportal/features/admin_amenities/presentation/pages/create_amenity_page.dart';
import 'package:rezmateportal/features/admin_amenities/presentation/pages/edit_amenity_page.dart';
import 'package:rezmateportal/features/admin_policies/presentation/pages/policies_management_page.dart';
import 'package:rezmateportal/features/admin_policies/presentation/pages/create_policy_page.dart';
import 'package:rezmateportal/features/admin_policies/presentation/pages/edit_policy_page.dart';
import 'package:rezmateportal/features/admin_policies/domain/entities/policy.dart';
import 'package:rezmateportal/features/admin_reviews/presentation/pages/reviews_list_page.dart';
import 'package:rezmateportal/features/admin_reviews/presentation/pages/review_details_page.dart';
// removed unused import: review entity
import 'package:rezmateportal/features/admin_reviews/presentation/bloc/reviews_list/reviews_list_bloc.dart'
    as ar_list_bloc;
...
import 'package:rezmateportal/features/admin_amenities/presentation/bloc/amenities_bloc.dart'
    as aa_bloc;
import 'package:rezmateportal/features/admin_policies/presentation/bloc/policies_bloc.dart'
    as apo_bloc;
...
import 'package:rezmateportal/features/admin_currencies/presentation/pages/currencies_management_page.dart'
    as ac_pages;
import 'package:rezmateportal/features/admin_currencies/presentation/bloc/currencies_bloc.dart'
    as ac_bloc;
import 'package:rezmateportal/features/admin_currencies/presentation/bloc/currencies_event.dart'
    as ac_events;
// Admin Cities page & bloc
import 'package:rezmateportal/features/admin_cities/presentation/pages/admin_cities_page.dart'
    as ci_pages;
import 'package:rezmateportal/features/admin_cities/presentation/bloc/cities_bloc.dart'
    as ci_bloc;
import 'package:rezmateportal/features/admin_cities/presentation/bloc/cities_event.dart'
    as ci_events;
// Admin Audit Logs page & bloc
import 'package:rezmateportal/features/admin_audit_logs/presentation/pages/audit_logs_page.dart'
    as al_pages;
import 'package:rezmateportal/features/admin_audit_logs/presentation/bloc/audit_logs_bloc.dart'
    as al_bloc;
// Admin Properties pages & blocs
import 'package:rezmateportal/features/admin_properties/presentation/pages/properties_list_page.dart'
    as ap_pages;
import 'package:rezmateportal/features/admin_properties/presentation/pages/create_property_page.dart'
    as ap_pages;
import 'package:rezmateportal/features/admin_properties/presentation/pages/edit_property_page.dart'
    as ap_pages;
import 'package:rezmateportal/features/admin_properties/presentation/pages/property_details_page.dart'
    as ap_pages;
import 'package:rezmateportal/features/admin_properties/presentation/bloc/properties/properties_bloc.dart'
    as ap_bloc;
import 'package:rezmateportal/features/admin_properties/presentation/bloc/property_types/property_types_bloc.dart'
    as ap_prop_pt_bloc;
// Admin Users pages & blocs
import 'package:rezmateportal/features/admin_users/presentation/pages/users_list_page.dart'
    as au_pages;
import 'package:rezmateportal/features/admin_users/presentation/pages/create_user_page.dart'
    as au_pages;
import 'package:rezmateportal/features/admin_users/presentation/pages/user_details_page.dart'
    as au_pages;
import 'package:rezmateportal/features/admin_users/presentation/bloc/users_list/users_list_bloc.dart'
    as au_list_bloc;
import 'package:rezmateportal/features/admin_users/presentation/bloc/user_details/user_details_bloc.dart'
    as au_details_bloc;
// Admin Daily Schedule
import 'package:rezmateportal/features/admin_daily_schedule/presentation/pages/daily_schedule_page.dart';
import 'package:rezmateportal/features/admin_daily_schedule/presentation/bloc/daily_schedule_barrel.dart';
import 'package:rezmateportal/features/onboarding/presentation/pages/select_city_currency_page.dart';
import 'package:rezmateportal/features/notifications/presentation/pages/notifications_page.dart';
import 'package:rezmateportal/features/notifications/presentation/pages/notification_settings_page.dart';
import 'package:rezmateportal/features/admin_hub/presentation/pages/admin_hub_page.dart';
import 'package:rezmateportal/features/settings/presentation/pages/in_app_webview_page.dart';
import 'package:rezmateportal/features/settings/presentation/pages/legal_documents_page.dart';
import 'package:rezmateportal/features/notifications/presentation/bloc/notification_bloc.dart'
    as notif_bloc;
import 'package:rezmateportal/features/notifications/presentation/bloc/notification_event.dart';
import 'package:rezmateportal/features/settings/presentation/pages/language_settings_page.dart';
import 'package:rezmateportal/features/settings/presentation/bloc/settings_bloc.dart'
    as st_bloc;
import 'package:rezmateportal/features/onboarding/presentation/bloc/onboarding_bloc.dart'
    as onboarding_bloc;
import 'package:rezmateportal/features/onboarding/presentation/bloc/onboarding_event.dart'
    as onboarding_event;
import 'package:rezmateportal/features/reference/presentation/bloc/reference_bloc.dart'
    as ref_bloc;
// Helpers search pages
import 'package:rezmateportal/features/helpers/presentation/pages/user_search_page.dart';
import 'package:rezmateportal/features/helpers/presentation/pages/property_search_page.dart';
import 'package:rezmateportal/features/helpers/presentation/pages/unit_search_page.dart';
import 'package:rezmateportal/features/helpers/presentation/pages/city_search_page.dart';
import 'package:rezmateportal/features/helpers/presentation/pages/booking_search_page.dart';
import 'package:rezmateportal/features/admin_units/presentation/pages/unit_gallery_page.dart';
...
import 'package:rezmateportal/features/admin_bookings/presentation/pages/bookings_list_page.dart';
import 'package:rezmateportal/features/admin_bookings/presentation/pages/booking_details_page.dart';
import 'package:rezmateportal/features/admin_bookings/presentation/pages/booking_audit_timeline_page.dart';
import 'package:rezmateportal/features/admin_bookings/presentation/pages/booking_calendar_page.dart';
import 'package:rezmateportal/features/admin_bookings/presentation/pages/booking_timeline_page.dart';
import 'package:rezmateportal/features/admin_bookings/presentation/pages/booking_analytics_page.dart';
import 'package:rezmateportal/features/admin_bookings/presentation/bloc/bookings_list/bookings_list_bloc.dart'
    as ab_list_bloc;
import 'package:rezmateportal/features/admin_bookings/presentation/bloc/bookings_list/bookings_list_event.dart'
    as ab_list_event;
import 'package:rezmateportal/features/admin_bookings/presentation/bloc/booking_details/booking_details_bloc.dart'
    as ab_details_bloc;
import 'package:rezmateportal/features/admin_bookings/presentation/bloc/booking_details/booking_details_event.dart'
    as ab_details_event;
import 'package:rezmateportal/features/admin_bookings/presentation/bloc/booking_calendar/booking_calendar_bloc.dart'
    as ab_cal_bloc;
import 'package:rezmateportal/features/admin_bookings/presentation/bloc/booking_calendar/booking_calendar_event.dart'
    as ab_cal_event;
import 'package:rezmateportal/features/admin_bookings/presentation/bloc/booking_analytics/booking_analytics_bloc.dart'
    as ab_an_bloc;
import 'package:rezmateportal/features/admin_bookings/presentation/bloc/booking_analytics/booking_analytics_event.dart'
    as ab_an_event;
// Admin Financial pages & blocs
import 'package:rezmateportal/features/admin_financial/presentation/pages/transactions_list_page.dart';
import 'package:rezmateportal/features/admin_financial/presentation/pages/chart_of_accounts_page.dart';
import 'package:rezmateportal/features/admin_financial/presentation/pages/financial_dashboard_page.dart';
import 'package:rezmateportal/features/admin_financial/presentation/bloc/accounts/accounts_bloc.dart'
    as fin_acc_bloc;
import 'package:rezmateportal/features/admin_financial/presentation/bloc/transactions/transactions_bloc.dart'
    as fin_trans_bloc;
import 'package:rezmateportal/features/admin_financial/presentation/bloc/financial_overview/financial_overview_bloc.dart'
    as fin_overview_bloc;
// Admin Payments pages & blocs
import 'package:rezmateportal/features/admin_payments/presentation/pages/payments_list_page.dart';
import 'package:rezmateportal/features/admin_payments/presentation/pages/payment_details_page.dart';
import 'package:rezmateportal/features/admin_payments/presentation/pages/payment_analytics_page.dart';
import 'package:rezmateportal/features/admin_payments/presentation/pages/refunds_management_page.dart';
import 'package:rezmateportal/features/admin_payments/presentation/pages/revenue_dashboard_page.dart';
...
import 'package:rezmateportal/features/admin_payments/presentation/bloc/payment_details/payment_details_event.dart'; // 🎯 إضافة
...
import 'package:rezmateportal/features/admin_sections/presentation/pages/sections_list_page.dart'
    as sec_pages;
import 'package:rezmateportal/features/admin_sections/presentation/pages/create_section_page.dart'
    as sec_pages;
import 'package:rezmateportal/features/admin_sections/presentation/pages/edit_section_page.dart'
    as sec_pages;
import 'package:rezmateportal/features/admin_sections/presentation/pages/section_items_management_page.dart'
    as sec_pages;
import 'package:rezmateportal/features/admin_sections/presentation/bloc/sections_list/sections_list_bloc.dart'
    as sec_list_bloc;
import 'package:rezmateportal/features/admin_sections/presentation/bloc/section_form/section_form_bloc.dart'
    as sec_form_bloc;
import 'package:rezmateportal/features/admin_sections/presentation/bloc/section_form/section_form_event.dart'
    as sec_form_event;
import 'package:rezmateportal/features/admin_sections/presentation/bloc/section_items/section_items_bloc.dart'
    as sec_items_bloc;
import 'package:rezmateportal/core/enums/section_target.dart' as sec_enums;
import 'package:rezmateportal/features/admin_notifications/presentation/bloc/admin_notifications_bloc.dart'
    as an_bloc;
import 'package:rezmateportal/features/admin_notifications/presentation/bloc/admin_notifications_event.dart'
    as an_events;
import 'package:rezmateportal/features/admin_notifications/presentation/pages/admin_notifications_page.dart';
import 'package:rezmateportal/features/admin_notifications/presentation/pages/create_admin_notification_page.dart';
import 'package:rezmateportal/features/admin_notifications/presentation/pages/user_notifications_page.dart';
import 'package:rezmateportal/features/admin_notifications/presentation/pages/user_selector_page.dart'
    as an_selector;
// Notification Channels pages
import 'package:rezmateportal/features/notification_channels/presentation/pages/channels_management_page.dart';
import 'package:rezmateportal/features/notification_channels/presentation/pages/channel_users_management_page.dart';
import 'package:rezmateportal/features/notification_channels/presentation/pages/create_channel_page.dart';
import 'package:rezmateportal/features/notification_channels/presentation/pages/edit_channel_page.dart';
import 'package:rezmateportal/features/notification_channels/presentation/bloc/channels_bloc.dart';
import 'package:rezmateportal/features/notification_channels/presentation/bloc/channels_event.dart';
        ...
        GoRoute(
          ...
          builder: (context, state) {
            ...
            final extra = state.extra is Map<String, dynamic>
                ...
                : const {};
            final bookingId =
                (extra['bookingId'] ?? qp['bookingId']) as String?;
            ...
            return BlocProvider<PaymentDetailsBloc>(
              create: (_) => di.sl<PaymentDetailsBloc>()
                ..add(LoadPaymentDetailsEvent(
                    paymentId: paymentId)), // 🎯 إضافة event
