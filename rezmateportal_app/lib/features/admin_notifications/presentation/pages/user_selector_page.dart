...
import 'package:rezmateportal/features/helpers/presentation/widgets/simple_filter_bar.dart';
import 'package:rezmateportal/features/helpers/presentation/widgets/search_header.dart';
import 'package:rezmateportal/features/helpers/domain/usecases/search_users_usecase.dart';
import 'package:rezmateportal/features/helpers/domain/entities/search_result.dart';
import 'package:rezmateportal/features/admin_users/domain/entities/user.dart';
import 'package:rezmateportal/features/helpers/presentation/widgets/search_item_card.dart';
...
import 'package:rezmateportal/core/widgets/empty_widget.dart';
...
class _AdminUserSelectorPageState extends State<AdminUserSelectorPage> {
  ...
  String? _normalizeRole(String? role) {
    ...
    if (lower.contains('staff') ||
        ...
        lower.contains('reception')) return 'Staff';
      ...
      body: SafeArea(
        child: Column(
          children: [
            SearchHeader(
              title:
                  widget.allowMultiSelect ? 'اختر المستخدمين' : 'اختر مستخدماً',
  ...
  Widget _buildContent() {
    ...
    if (_hasError) {
      return CustomErrorWidget(
          message: _errorMessage, onRetry: () => _load(refresh: true));
    }
    if (_users.isEmpty) {
