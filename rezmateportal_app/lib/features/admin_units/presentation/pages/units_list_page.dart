...
import 'package:rezmateportal/features/auth/domain/entities/user.dart'
    as domain;
import 'package:rezmateportal/features/admin_daily_schedule/presentation/widgets/real_property_selector_card.dart';
  ...
  Widget _buildStatsCards(UnitsListLoaded state) {
    ...
    */
    final availableUnits =
        state.stats != null && state.stats!['availableUnits'] != null
            ? int.tryParse('${state.stats!['availableUnits']}') ?? 0
            : 0;
    final occupiedUnits =
        state.stats != null && state.stats!['occupiedUnits'] != null
                      ...
                      child: Padding(
                        ...
                        child: RealPropertySelectorCard(
                          ...
                          onPropertySelected: (id, name) {
                            ...
                            final enforcedPropertyId = (user != null &&
                                    user.isOwner &&
                            ...
                            setState(() {
                              ...
                              _activeFilters =
                                  UnitFilters(propertyId: enforcedPropertyId);
                            });
