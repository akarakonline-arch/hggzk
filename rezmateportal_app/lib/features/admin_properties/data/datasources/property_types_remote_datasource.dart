...
abstract class PropertyTypesRemoteDataSource {
  ...
  Future<bool> updatePropertyType(
      String propertyTypeId, Map<String, dynamic> data);
...
class PropertyTypesRemoteDataSourceImpl
  ...
  Future<PaginatedResult<PropertyTypeModel>> getAllPropertyTypes({
    ...
    try {
      ...
      throw ServerException(
          e.response?.data['message'] ?? 'Failed to fetch property types');
    }
  }
  ...
  Future<PropertyTypeModel> getPropertyTypeById(String propertyTypeId) async {
    try {
      ...
      if (response.data['success'] == true) {
        ...
        throw ServerException(
            response.data['message'] ?? 'Failed to get property type');
      }
    } on DioException catch (e) {
      throw ServerException(
          e.response?.data['message'] ?? 'Failed to fetch property type');
    }
  }
  ...
  Future<String> createPropertyType(Map<String, dynamic> data) async {
    try {
      ...
      if (response.data['success'] == true) {
        ...
        throw ServerException(
            response.data['message'] ?? 'Failed to create property type');
      }
    } on DioException catch (e) {
      throw ServerException(
          e.response?.data['message'] ?? 'Failed to create property type');
    }
  }
  ...
  Future<bool> updatePropertyType(
    ...
    try {
      ...
      throw ServerException(
          e.response?.data['message'] ?? 'Failed to update property type');
    }
  }
  ...
  Future<bool> deletePropertyType(String propertyTypeId) async {
    try {
      ...
      throw ServerException(
          e.response?.data['message'] ?? 'Failed to delete property type');
    }
  }
}
