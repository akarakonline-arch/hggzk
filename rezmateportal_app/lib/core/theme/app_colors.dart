...
class AppColors {
  ...
  static Color get surface => AppTheme.isDark ? AppTheme.darkSurface : AppTheme.lightSurface;
  static Color get background => AppTheme.isDark ? AppTheme.darkBackground : AppTheme.lightBackground;
  static Color get text => AppTheme.isDark ? AppTheme.textWhite : AppTheme.textDark;
  static Color get textSecondary => AppTheme.textMuted;
  static Color get accent => AppTheme.primaryCyan;
}