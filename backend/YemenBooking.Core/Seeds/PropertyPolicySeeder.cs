    ...
    public class PropertyPolicySeeder : ISeeder<PropertyPolicy>
    {
        ...
        public IEnumerable<PropertyPolicy> SeedData()
        {
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                CancellationFreeCancel = true,
                CancellationFullRefund = true,
                CancellationPenaltyAfterDeadline = "100%",
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                PaymentDepositRequired = true,
                PaymentAcceptedMethods = new[] { "بطاقة ائتمان", "نقداً", "تحويل بنكي" },
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                CheckInTime = TimeOnly.Parse("14:00"),
                CheckOutTime = TimeOnly.Parse("12:00"),
                CheckInEarlyCheckInNote = "متاح بطلب مسبق",
                CheckInLateCheckOutNote = "متاح مقابل رسوم",
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                ChildrenFreeUnderAge = 6,
                ChildrenHalfPriceUnderAge = 12,
                ChildrenMaxChildrenPerRoom = 2,
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 0,
                MinHoursBeforeCheckIn = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                PetsAllowed = false,
                PetsReason = "للحفاظ على راحة جميع النزلاء",
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 0,
                MinHoursBeforeCheckIn = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                ModificationFreeModificationHours = 24,
                ModificationFeesAfter = "10% من قيمة الحجز",
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 0,
                MinHoursBeforeCheckIn = 24,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                CancellationFreeCancel = false,
                CancellationRefundPercentage = 50,
                CancellationDaysBeforeCheckIn = 7,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                PaymentFullPaymentRequired = true,
                PaymentAcceptedMethods = new[] { "بطاقة ائتمان", "تحويل بنكي" },
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = true,
                MinimumDepositPercentage = 100,
                MinHoursBeforeCheckIn = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                CheckInTime = TimeOnly.Parse("15:00"),
                CheckOutTime = TimeOnly.Parse("11:00"),
                CheckInLateCheckOutFee = "50% من سعر الليلة",
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 0,
                MinHoursBeforeCheckIn = 48,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                ChildrenAllowed = true,
                ChildrenFreeUnderAge = 12,
                ChildrenMaxChildren = 3,
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 0,
                MinHoursBeforeCheckIn = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                PetsAllowed = true,
                PetsFeeAmount = 5000,
                PetsMaxWeight = "10 كجم",
                PetsRequiresApproval = true,
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 0,
                MinHoursBeforeCheckIn = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                CancellationFreeCancel = true,
                CancellationDaysBeforeCheckIn = 5,
                CancellationPenaltyAfterDeadline = "فقدان المقدمة",
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                PaymentDepositPercentage = 30,
                PaymentAcceptCash = true,
                PaymentAcceptCard = false,
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 30,
                MinHoursBeforeCheckIn = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                CheckInFrom = TimeOnly.Parse("12:00"),
                CheckInUntil = TimeOnly.Parse("22:00"),
                CheckOutTime = TimeOnly.Parse("12:00"),
                CheckInFlexible = true,
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                ChildrenAllowed = true,
                ChildrenFreeUnderAge = 3,
                ChildrenCribsNote = "متوفرة عند الطلب",
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 0,
                MinHoursBeforeCheckIn = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                CancellationNonRefundable = true,
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = true,
                MinimumDepositPercentage = 100,
                MinHoursBeforeCheckIn = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                PaymentFullPaymentRequired = true,
                PaymentAcceptedMethods = new[] { "بطاقة ائتمان" },
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = true,
                MinimumDepositPercentage = 100,
                MinHoursBeforeCheckIn = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                CheckInFlexibleCheckIn = true,
                CheckInRequiresCoordination = true,
                CheckInContactOwner = true,
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                ModificationReason = "حجز غير قابل للتعديل",
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 0,
                MinHoursBeforeCheckIn = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                PaymentDepositPercentage = 10,
                PaymentPayAtProperty = true,
                PaymentCashPreferred = true,
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 10,
                MinHoursBeforeCheckIn = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                ChildrenAllowed = true,
                ChildrenFreeUnderAge = 8,
                ChildrenPlaygroundAvailable = true,
                ChildrenKidsMenuAvailable = true,
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 0,
                MinHoursBeforeCheckIn = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                PetsAllowed = true,
                PetsNoFees = true,
                PetsPetFriendly = true,
                PetsOutdoorSpace = true,
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 0,
                MinHoursBeforeCheckIn = 0,
            ...
            policies.Add(new PropertyPolicy
            {
                ...
                ModificationAllowed = true,
                ModificationFreeModificationHours = 12,
                ModificationFlexible = true,
                CancellationWindowDays = 0,
                RequireFullPaymentBeforeConfirmation = false,
                MinimumDepositPercentage = 0,
                MinHoursBeforeCheckIn = 12,
