...
import 'package:hggzkportal/features/admin_properties/data/datasources/property_types_remote_datasource.dart'
    as ap_ds_pt_remote;
import 'package:hggzkportal/features/admin_properties/data/models/property_type_model.dart'
    as ap_models;
...
class _RegisterFormState extends State<RegisterForm>
      ...
      ..onTap = () {
        context.push(
          ...
          extra: <String, dynamic>{
            ...
            'url': 'https://www.hggzk.com/terms-partners',
          },
        );
      };
      ...
      children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildEnhancedField(
                    ...
                    focusNode: item.accountNumberFocusNode,
                  ...
                  _buildEnhancedField(
                    ...
                    focusNode: item.accountNameFocusNode,
        ...
        Align(
          ...
          child: TextButton.icon(
            ...
            label: Text(
              'إضافة حساب',
              style: AppTextStyles.bodySmall.copyWith(color: AppTheme.primaryBlue),
            ),
          ),
        ),
      ],
  ...
  List<Map<String, dynamic>>? _buildWalletAccountsPayload() {
    ...
    for (int i = 0; i < items.length; i++) {
      items[i]['isDefault'] = (firstDefaultIndex == -1) ? (i == 0) : (i == firstDefaultIndex);
    }
    return items;
  }
