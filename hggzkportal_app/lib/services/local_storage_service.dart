...
// Currency methods
  ...
  Future<bool> saveAccountRole(String role) async =>
      _prefs.setString(_accountRoleKey, role);
  String getAccountRole() => _prefs.getString(_accountRoleKey) ?? '';

  Future<bool> savePropertyContext(
      {String? id, String? name, String? currency}) async {
